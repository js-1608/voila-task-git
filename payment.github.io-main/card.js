...
cDetails = document.getElementById('card-details'),
internetBankingDetails = document.getElementById('internet-banking-details'),
appleGooglePayDetails = document.getElementById('apple-google-pay-details');
...
function doFun(){
 ...
 appleGooglePayDetails.style.display = "none";
}
...
function doFunB(){
 ...
 cDetails.style.display = "none";
 internetBankingDetails.style.display = "none";
 appleGooglePayDetails.style.display = "block";
}
